  ...
  "days": [
    {
      ...
      "note": "今日 arXiv recent 中文整理：共 28 篇，str-el 24 篇，supr-con 9 篇。",
      "stats": {
        "total": 28,
        "str": 24,
        "supr": 9
      ...
      "papers": [
        {
          ...
          "important": true,
          "score": 34,
          "oneLine": "本文研究 the emergence of nontrivial topology in a twisted cuprate bilayer described by the Hubbard model in the weak-interaction regime。",
          "problem": "这篇论文关注：the emergence of nontrivial topology in a twisted cuprate bilayer described by the Hubbard model in the weak-interaction regime？",
          "result": "结果表明，the topological character depends sensitively on the doping level。",
          "methods": "Hubbard 模型分析。",
          "why": "同时出现在 str-el 与 supr-con，适合优先看强关联与超导交叉。",
          "summary": "本文研究 the emergence of nontrivial topology in a twisted cuprate bilayer described by the Hubbard model in the weak-interaction regime。",
          ...
          "comments": "7 pages, 7 figures. Associated data can be found at this https URL",
          "journalRef": "",
        ...
        },
        {
          ...
          "important": true,
          "score": 26,
          "oneLine": "本文研究 altermagnetism provides a field-free mechanism for stabilizing finite-momentum superconductivity in two dimensions。",
          "problem": "这篇论文关注：altermagnetism provides a field-free mechanism for stabilizing finite-momentum superconductivity in two dimensions？",
          "result": "结果表明，altermagnetism provides a field-free mechanism for stabilizing finite-momentum superconductivity in two dimensions。",
          "methods": "Monte Carlo 模拟。",
          "why": "同时出现在 str-el 与 supr-con，适合优先看强关联与超导交叉。",
          "summary": "本文研究 altermagnetism provides a field-free mechanism for stabilizing finite-momentum superconductivity in two dimensions。",
          ...
          "url": "https://arxiv.org/abs/2605.07656"
        },
        {
          "id": "2605.07540",
          ...
          "important": true,
          "score": 19,
          "oneLine": "本文研究 CrRhAs was theoretically proposed to be a kagome metal with unusual magnetic ground states; however, little is known about its magnetic structure and physical properties experimentally。",
          "problem": "这篇论文关注：CrRhAs was theoretically proposed to be a kagome metal with unusual magnetic ground states; however, little is known about its magnetic structure and physical properties experimentally？",
          "result": "结果表明，Combined with the results of heat capacity measurements, a large Kadowaki-Woods ratio {\\alpha} = 33.9 {\\mu}{\\Omega} cm mol2 K2/J2 is obtained。",
          "methods": "DFT 计算、中子散射实验、输运测量。",
          "why": "同时出现在 str-el 与 supr-con，适合优先看强关联与超导交叉。",
          "summary": "本文研究 CrRhAs was theoretically proposed to be a kagome metal with unusual magnetic ground states; however, little is known about its magnetic structure and physical properties experimentally。",
          ...
          "journalRef": "Phys. Rev. B 113, 184430 (2026)",
          ...
          "url": "https://arxiv.org/abs/2605.07540"
        },
        {
          "id": "2605.08067",
          ...
          "important": false,
          "score": 17,
          "oneLine": "本文研究 Fractional magnetization plateaus provide a sensitive probe of many-body spin states in frustrated quantum magnets, yet their microscopic origin in kagome antiferromagnets remains unresolved。",
          "problem": "这篇论文关注：Fractional magnetization plateaus provide a sensitive probe of many-body spin states in frustrated quantum magnets, yet their microscopic origin in kagome antiferromagnets remains unresolved？",
          "result": "结果表明，We identify a hierarchy of field-induced fractional features, including $1/3$ and $1/9$ plateaus, as well as a weaker low-field feature。",
          "methods": "NMR 谱学。",
          "why": "包含 kagome 或受挫晶格主题，和强关联材料阅读线索高度相关。",
          "summary": "本文研究 Fractional magnetization plateaus provide a sensitive probe of many-body spin states in frustrated quantum magnets, yet their microscopic origin in kagome antiferromagnets remains unresolved。",
          ...
          "priorityReason": "包含 kagome 或受挫晶格主题，和强关联材料阅读线索高度相关。",
        ...
        },
        {
          ...
          "important": false,
          "score": 17,
          "oneLine": "本文研究 Quantum spin liquids (QSLs) represent highly entangled states of matter in which frustration-induced quantum fluctuations suppress any symmetry-breaking phase transition down to absolute...。",
          "problem": "这篇论文关注：Quantum spin liquids (QSLs) represent highly entangled states of matter in which frustration-induced quantum fluctuations suppress any symmetry-breaking phase transition down to absolute zero, giving rise to？",
          "result": "结果表明，Here we identify the three-dimensional spin-trimer magnet KBa$_3$Ca$_4$Cu$_3$V$_7$O$_{28}$ as a promising candidate for a bipartite quantum spin liquid persisting to the lowest temperatures。",
          "methods": "Monte Carlo 模拟、中子散射实验、NMR 谱学。",
          "why": "涉及量子自旋液体，和受挫强关联体系密切相关。",
          "summary": "本文研究 Quantum spin liquids (QSLs) represent highly entangled states of matter in which frustration-induced quantum fluctuations suppress any symmetry-breaking phase transition down to absolute...。",
          ...
          "priorityReason": "涉及量子自旋液体，和受挫强关联体系密切相关。",
          "comments": "",
          "journalRef": "",
          ...
          "url": "https://arxiv.org/abs/2605.06752"
        },
        {
          "id": "2605.07739",
          ...
          "important": false,
          "score": 15,
          "oneLine": "本文研究 The Emery model is the quintessential model for cuprate superconductors。",
          "problem": "这篇论文关注：The Emery model is the quintessential model for cuprate superconductors？",
          "result": "结果表明，Using dynamical vertex approximation, we find a superconducting dome consistent with cuprates。",
          "methods": "方法上，Using dynamical vertex approximation, we find a superconducting dome consistent with cuprates。",
          "why": "同时出现在 str-el 与 supr-con，适合优先看强关联与超导交叉。",
          "summary": "本文研究 The Emery model is the quintessential model for cuprate superconductors。",
          ...
          "url": "https://arxiv.org/abs/2605.07739"
        },
        {
          "id": "2605.08049",
          ...
          "important": false,
          "score": 14,
          "oneLine": "本文研究 Hidden multipolar orders in spin-orbit-coupled Mott insulators provide a promising setting for correlated quantum matter, yet their control and detection remain major challenges。",
          "problem": "这篇论文关注：Hidden multipolar orders in spin-orbit-coupled Mott insulators provide a promising setting for correlated quantum matter, yet their control and detection remain major challenges？",
          "result": "结果表明，circularly polarized light enables both in $4d^2/5d^2$ systems with edge-sharing octahedra。",
          "methods": "Hubbard 模型分析。",
          "why": "Hubbard 模型相关，适合从模型层面理解关联与配对。",
          "summary": "本文研究 Hidden multipolar orders in spin-orbit-coupled Mott insulators provide a promising setting for correlated quantum matter, yet their control and detection remain major challenges。",
        ...
        },
        {
          ...
          "important": false,
          "score": 12,
          "oneLine": "本文研究 While deep learning offers powerful capabilities for scientific research, its application is often hindered by a lack of quantitative reliability。",
          "problem": "这篇论文关注：While deep learning offers powerful capabilities for scientific research, its application is often hindered by a lack of quantitative reliability？",
          "result": "结果表明，this approach on three-dimensional angle-resolved photoemission spectroscopy data, showing that the model reliably recovers the spectral features of a cuprate superconductor from Poisson-distributed noise。",
          "methods": "谱学分析、X 射线表征。",
          "why": "同时出现在 str-el 与 supr-con，适合优先看强关联与超导交叉。",
          "summary": "本文研究 While deep learning offers powerful capabilities for scientific research, its application is often hindered by a lack of quantitative reliability。",
          ...
          "journalRef": "",
          "subjects": "Strongly Correlated Electrons (cond-mat.str-el) ; Superconductivity (cond-mat.supr-con); Data Analysis, Statistics and Probability (physics.data-an)",
          "sourceCategories": [
            "cond-mat.str-el",
            "cond-mat.supr-con"
          ],
          "url": "https://arxiv.org/abs/2605.07819"
        },
        {
          "id": "2605.07336",
          ...
          "important": false,
          "score": 10,
          "oneLine": "本文研究 Two-dimensional (2D) transition metal dichalcogenides (TMDs) are promising platforms for low dimensional superconductivity。",
          "problem": "这篇论文关注：Two-dimensional (2D) transition metal dichalcogenides (TMDs) are promising platforms for low dimensional superconductivity？",
          "result": "结果表明，However, in conventional intercalated systems, achieving a high superconducting transition temperature (Tc) often comes at the expense of reduced interlayer spacing and weakened 2D character。",
          "methods": "输运测量。",
          "why": "涉及 Ising 超导，适合关注低维强自旋轨道体系。",
          "summary": "本文研究 Two-dimensional (2D) transition metal dichalcogenides (TMDs) are promising platforms for low dimensional superconductivity。",
          ...
          "priorityReason": "涉及 Ising 超导，适合关注低维强自旋轨道体系。",
          "comments": "Mian Text 26 pages, 6 figures abd SI 6 pages, 1 figure, 3 tables",
          "journalRef": "Journal of The American Chemical of Society, 2026",
          "subjects": "Superconductivity (cond-mat.supr-con)",
          "sourceCategories": [
            "cond-mat.supr-con"
          ],
          "url": "https://arxiv.org/abs/2605.07336"
        },
        {
          "id": "2605.07685",
          "title": "Ground states of quantum XY dipoles on the Archimedean lattices",
          ...
          "important": false,
          "score": 9,
          "oneLine": "本文研究 numerical ground states for the dipolar XY spin model, which describes extended antiferromagnetic interactions in two-dimensional arrays of polar molecules and two-level Rydberg atoms。",
          "problem": "这篇论文关注：numerical ground states for the dipolar XY spin model, which describes extended antiferromagnetic interactions in two-dimensional arrays of polar molecules and two-level Rydberg atoms？",
          "result": "结果表明，We also investigate the triangular lattice, for which we find several competing phases including coplanar magnetism, stripe density wave order, and a possible spin liquid; their relative stability is sensitive...。",
          "methods": "重整化群分析。",
          "why": "包含 kagome 或受挫晶格主题，和强关联材料阅读线索高度相关。",
          "summary": "本文研究 numerical ground states for the dipolar XY spin model, which describes extended antiferromagnetic interactions in two-dimensional arrays of polar molecules and two-level Rydberg atoms。",
          ...
          "url": "https://arxiv.org/abs/2605.07685"
        },
        {
          "id": "2605.07862",
          ...
          "important": false,
          "score": 8,
          "oneLine": "本文研究 SrCu2(BO3)2 (SCBO) is a paradigmatic realization of the Shastry-Sutherland model, hosting geometrically frustrated spin dimers and a variety of quantum magnetic phases and phenomena。",
          "problem": "这篇论文关注：SrCu2(BO3)2 (SCBO) is a paradigmatic realization of the Shastry-Sutherland model, hosting geometrically frustrated spin dimers and a variety of quantum magnetic phases and phenomena？",
          "result": "结果表明，Taken together, these results define the characteristic energy scales of d-d and CT excitations, offering quantitative benchmarks for computational frameworks and providing essential input for refining。",
          "methods": "DFT 计算、谱学分析、X 射线表征。",
          "why": "涉及受挫磁性，适合关注低维量子磁性和新奇基态。",
          "summary": "本文研究 SrCu2(BO3)2 (SCBO) is a paradigmatic realization of the Shastry-Sutherland model, hosting geometrically frustrated spin dimers and a variety of quantum magnetic phases and phenomena。",
          ...
          "priorityReason": "涉及受挫磁性，适合关注低维量子磁性和新奇基态。",
          "comments": "",
          "journalRef": "",
          "subjects": "Strongly Correlated Electrons (cond-mat.str-el)",
          "sourceCategories": [
          ...
          "url": "https://arxiv.org/abs/2605.07862"
        },
        {
          "id": "2605.06828",
          ...
          "important": false,
          "score": 6,
          "oneLine": "本文研究 Majorana zero modes are central to the pursuit of fault-tolerant topological quantum computation。",
          "problem": "这篇论文关注：Majorana zero modes are central to the pursuit of fault-tolerant topological quantum computation？",
          "result": "结果表明，Our analytical results explicitly demonstrate the critical role of spin-orbit coupling for the stabilization of Majorana modes and provides approximate analytical expressions for low-lying states localized at...。",
          "methods": "方法上，Such skyrmion-vortex pairs have recently been realized experimentally and are theorized to harbor localized Majorana states, offering a potential pathway for braiding operations。",
          "why": "涉及 Majorana 物理，适合关注拓扑超导与器件解释。",
          "summary": "本文研究 Majorana zero modes are central to the pursuit of fault-tolerant topological quantum computation。",
          ...
          "url": "https://arxiv.org/abs/2605.06828"
        },
        {
          "id": "2605.06798",
          ...
          "important": false,
          "score": 6,
          "oneLine": "本文研究 Rutile RuO$_2$ has attracted significant interest due to its putative unconventional electronic and magnetic properties and its proximity to superconductivity。",
          "problem": "这篇论文关注：Rutile RuO$_2$ has attracted significant interest due to its putative unconventional electronic and magnetic properties and its proximity to superconductivity？",
          "result": "结果表明，how the preparation of targeted $(110)$ and $(100)$ surfaces via focused ion beam (FIB)-engineered cleaving allows the acquisition of high-quality measurements of the electronic structure using。",
          "methods": "ARPES 谱学、谱学分析。",
          "why": "包含谱学信息，可帮助快速判断实验可观测量。",
          "summary": "本文研究 Rutile RuO$_2$ has attracted significant interest due to its putative unconventional electronic and magnetic properties and its proximity to superconductivity。",
        ...
        },
        {
          ...
          "important": false,
          "score": 5,
          "oneLine": "本文研究 Quantum-disordered magnetic ground states are challenging to identify in three-dimensional (3D) oxides, where strong exchange pathways typically favour long-range magnetic order or spin...。",
          "problem": "这篇论文关注：Quantum-disordered magnetic ground states are challenging to identify in three-dimensional (3D) oxides, where strong exchange pathways typically favour long-range magnetic order or spin freezing？",
          "result": "结果表明，Quantum-disordered magnetic ground states are challenging to identify in three-dimensional (3D) oxides, where strong exchange pathways typically favour long-range magnetic order or spin freezing。",
          "methods": "方法上，Here, we combine bulk probes, including DC and AC magnetic susceptibility, and heat capacity measurements (down to $50~\\mathrm{mK}$), along with the local microscopic probe muon spin...。",
          "why": "涉及 heavy fermion，适合关注强关联低能准粒子与量子临界。",
          "summary": "本文研究 Quantum-disordered magnetic ground states are challenging to identify in three-dimensional (3D) oxides, where strong exchange pathways typically favour long-range magnetic order or spin...。",
          ...
          "priorityReason": "涉及 heavy fermion，适合关注强关联低能准粒子与量子临界。",
          ...
          "url": "https://arxiv.org/abs/2605.07602"
        },
        {
          "id": "2605.07294",
          "title": "Frustration of harmonic and solitonic helimagnetism on the body-centered tetragonal lattice of GdAlSi",
          ...
          "important": false,
          "score": 5,
          "oneLine": "本文研究 The triangular lattice antiferromagnet (TLAF) with nearest-neighbor exchange interaction is a model platform in the field of frustrated magnetism。",
          "problem": "这篇论文关注：The triangular lattice antiferromagnet (TLAF) with nearest-neighbor exchange interaction is a model platform in the field of frustrated magnetism？",
          "result": "结果表明，a body-centered tetragonal lattice (BCTL) can realize a similar frustration of harmonic and anharmonic helimagnetic states, and that the tetragonal magnetic Weyl semimetal GdAlSi realizes this scenario。",
          "methods": "平均场理论、X 射线表征。",
          "why": "涉及受挫磁性，适合关注低维量子磁性和新奇基态。",
          "summary": "本文研究 The triangular lattice antiferromagnet (TLAF) with nearest-neighbor exchange interaction is a model platform in the field of frustrated magnetism。",
          ...
          "url": "https://arxiv.org/abs/2605.07294"
        },
        {
          "id": "2605.06852",
          ...
          "important": false,
          "score": 5,
          "oneLine": "本文研究 In general, quantum fluctuations are suppressed in ferromagnetic materials because they admit a simple unfrustrated ground state, greatly limiting the scope of phenomena that can be...。",
          "problem": "这篇论文关注：In general, quantum fluctuations are suppressed in ferromagnetic materials because they admit a simple unfrustrated ground state, greatly limiting the scope of phenomena that can be observed in these materials？",
          "result": "结果表明，In this work, we show how magnetization-non-conserving couplings fundamentally alter this paradigm by demonstrating the existence of a chiral ferromagnet that is stabilized by quantum fluctuations。",
          "methods": "输运测量。",
          "why": "涉及受挫磁性，适合关注低维量子磁性和新奇基态。",
          "summary": "本文研究 In general, quantum fluctuations are suppressed in ferromagnetic materials because they admit a simple unfrustrated ground state, greatly limiting the scope of phenomena that can be...。",
        ...
        {
          "id": "2605.07946",
          "title": "Microscopic Magnetism of A(TiO)Cu4(PO4)4 (A = Ba, Pb, Sr): 31P and 63,65Cu NMR Study",
          ...
          "important": false,
          "score": 3,
          "oneLine": "本文研究 a comprehensive NMR study of the chiral square-cupola antiferromagnet Pb(TiO)Cu$_4$(PO$_4$)$_4$ and compare its microscopic hyperfine and local-field parameters with the Ba/Sr analogues in...。",
          "problem": "这篇论文关注：a comprehensive NMR study of the chiral square-cupola antiferromagnet Pb(TiO)Cu$_4$(PO$_4$)$_4$ and compare its microscopic hyperfine and local-field parameters with the Ba/Sr analogues in the？",
          "result": "结果表明，Comparing PbTCPO with BaTCPO and SrTCPO, we find that the transferred hyperfine coupling $H_{\\rm hf}$ varies across the series, reflecting changes in local Cu-O-P covalency, whereas the ordered-state $^{31}$P...。",
          "methods": "NMR 谱学。",
          "why": "包含 NMR 线索，适合关注磁性和低能涨落。",
          "summary": "本文研究 a comprehensive NMR study of the chiral square-cupola antiferromagnet Pb(TiO)Cu$_4$(PO$_4$)$_4$ and compare its microscopic hyperfine and local-field parameters with the Ba/Sr analogues in...。",
          ...
          "priorityReason": "包含 NMR 线索，适合关注磁性和低能涨落。",
          "comments": "13 pages, 11 figures, 5 tables",
          "journalRef": "Phys. Rev. B 113, 184428 (2026)",
          "subjects": "Strongly Correlated Electrons (cond-mat.str-el)",
          "sourceCategories": [
            "cond-mat.str-el"
          ],
          "url": "https://arxiv.org/abs/2605.07946"
        },
        {
          "id": "2605.07887",
          ...
          "important": false,
          "score": 3,
          "oneLine": "本文研究 Parafermions with non-Abelian statistics have been proposed as a promising platform for quantum computation, potentially enabling a broader set of topologically protected gates than...。",
          "problem": "这篇论文关注：Parafermions with non-Abelian statistics have been proposed as a promising platform for quantum computation, potentially enabling a broader set of topologically protected gates than Majorana fermions？",
          "result": "结果表明，The experimental and theoretical exploration of these exotic quasiparticles remains challenging, as their stability is linked to strong electron-electron interactions。",
          "methods": "重整化群分析、输运测量。",
          "why": "涉及 Majorana 物理，适合关注拓扑超导与器件解释。",
          "summary": "本文研究 Parafermions with non-Abelian statistics have been proposed as a promising platform for quantum computation, potentially enabling a broader set of topologically protected gates than...。",
        ...
        },
        {
          ...
          "important": false,
          "score": 3,
          "oneLine": "本文研究 a test of conformal invariance in critical phenomena based on the study of a two-point correlation function in the presence of a boundary。",
          "problem": "这篇论文关注：a test of conformal invariance in critical phenomena based on the study of a two-point correlation function in the presence of a boundary？",
          "result": "结果表明，This two-point function can be studied using X-ray or neutron scattering in the conditions of total reflection (so-called grazing scattering)。",
          "methods": "中子散射实验、X 射线表征。",
          "why": "包含中子散射线索，适合关注磁结构和集体激发。",
          "summary": "本文研究 a test of conformal invariance in critical phenomena based on the study of a two-point correlation function in the presence of a boundary。",
          ...
          "journalRef": "",
          "subjects": "Statistical Mechanics (cond-mat.stat-mech) ; Materials Science (cond-mat.mtrl-sci); Soft Condensed Matter (cond-mat.soft); Strongly Correlated Electrons (cond-mat.str-el); High Energy Physics - Theory (hep-th)",
          "sourceCategories": [
            "cond-mat.str-el"
          ],
          "url": "https://arxiv.org/abs/2605.06773"
        },
        {
          "id": "2605.08032",
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 The celebrated Kronig-Penney model traditionally has been formulated with square well potentials representing atomic centres。",
          "problem": "这篇论文关注：The celebrated Kronig-Penney model traditionally has been formulated with square well potentials representing atomic centres？",
          "result": "结果表明，Here, we use a slightly more realistic potential, the truncated harmonic oscillator, in lieu of square well potentials, and solve the model analytically。",
          "methods": "紧束缚模型。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 The celebrated Kronig-Penney model traditionally has been formulated with square well potentials representing atomic centres。",
          ...
          "url": "https://arxiv.org/abs/2605.08032"
        },
        {
          "id": "2605.07734",
          "title": "Characterizing bulk properties of gapped phases by smeared boundary conformal field theories: Role of duality in unusual ordering",
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 the classification of the gapped phases or massive renormalization group (RG) flows dual to the massless RG flows under changing the sign of the coupling constants。",
          "problem": "这篇论文关注：the classification of the gapped phases or massive renormalization group (RG) flows dual to the massless RG flows under changing the sign of the coupling constants？",
          "result": "结果表明，For example, we demonstrate that the massive RG flow dual to the massless RG flow from the tricritical Ising model to the Ising model, one of the simplest massless RG flows, has this unusual structure。",
          "methods": "重整化群分析。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 the classification of the gapped phases or massive renormalization group (RG) flows dual to the massless RG flows under changing the sign of the coupling constants。",
          ...
          "url": "https://arxiv.org/abs/2605.07734"
        },
        {
          "id": "2605.07621",
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 the entanglement structure of quantum many-body states defines a natural and optimal distributed representation for their simulation。",
          "problem": "这篇论文关注：the entanglement structure of quantum many-body states defines a natural and optimal distributed representation for their simulation？",
          "result": "结果表明，the entanglement structure of quantum many-body states defines a natural and optimal distributed representation for their simulation。",
          "methods": "方法上，the entanglement structure of quantum many-body states defines a natural and optimal distributed representation for their simulation。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 the entanglement structure of quantum many-body states defines a natural and optimal distributed representation for their simulation。",
        ...
        {
          "id": "2605.07118",
          "title": "Revisiting magnetoelectric response in collinear antiferromagnetic zigzag chains: A downfolding approach beyond conventional low-energy models",
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 Magnetoelectric (ME) effects in antiferromagnets provide a fertile platform for exploring symmetry-driven cross-correlated responses。",
          "problem": "这篇论文关注：Magnetoelectric (ME) effects in antiferromagnets provide a fertile platform for exploring symmetry-driven cross-correlated responses？",
          "result": "结果表明，Using analytical and numerical calculations based on the Kubo formula, we demonstrate that the ME response is governed by orbital degrees of freedom activated through $s$--$p$ hybridization, while the spin...。",
          "methods": "重整化群分析、紧束缚模型。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 Magnetoelectric (ME) effects in antiferromagnets provide a fertile platform for exploring symmetry-driven cross-correlated responses。",
          ...
          "url": "https://arxiv.org/abs/2605.07118"
        },
        {
          "id": "2605.07085",
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 We have investigated the weak antilocalization (WAL) in the pressurized Dirac semimetal $\\alpha$-(BEDT-TTF)$_2$I$_3$ across a correlation-driven quantum phase transition to a charge-ordered...。",
          "problem": "这篇论文关注：We have investigated the weak antilocalization (WAL) in the pressurized Dirac semimetal $\\alpha$-(BEDT-TTF)$_2$I$_3$ across a correlation-driven quantum phase transition to a charge-ordered insulating state and？",
          "result": "结果表明，In the high-pressure regime, the system exhibits the conventional two-dimensional dephasing behavior ($L_{\\phi} \\propto T^{-p}$ with $p \\approx 1/2$), characteristic of electron-electron scattering in diffusive。",
          "methods": "方法上，As the pressure approaches the critical pressure ($P_c \\sim 1.2$ GPa), the temperature exponent is suppressed to $p \\sim 0.3$, while $L_{\\phi}$ remains large ($700\\text{-}800$ nm at 0.5 K)。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 We have investigated the weak antilocalization (WAL) in the pressurized Dirac semimetal $\\alpha$-(BEDT-TTF)$_2$I$_3$ across a correlation-driven quantum phase transition to a charge-ordered...。",
          ...
          "journalRef": "J. Phys. Soc. Jpn. 95, 063703 (2026)",
          "subjects": "Strongly Correlated Electrons (cond-mat.str-el)",
          "sourceCategories": [
            "cond-mat.str-el"
          ],
          "url": "https://arxiv.org/abs/2605.07085"
        },
        {
          "id": "2605.06801",
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 the claims by Park and Haldane [Phys。",
          "problem": "这篇论文关注：the claims by Park and Haldane [Phys？",
          "result": "结果表明，Contrary to prevailing expectations, we find that the edge dipole takes the expected intrinsic value only in certain very special cases。",
          "methods": "重整化群分析。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 the claims by Park and Haldane [Phys。",
        ...
        },
        {
          ...
          "important": false,
          "score": -5,
          "oneLine": "本文研究 a Python package for ground-state preparation based on the probabilistic imaginary-time evolution algorithm, with particular focus on its state-vector-based implementation。",
          "problem": "这篇论文关注：a Python package for ground-state preparation based on the probabilistic imaginary-time evolution algorithm, with particular focus on its state-vector-based implementation？",
          "result": "结果表明，A standard shot-based simulation is also supported, and results can be benchmarked against exact diagonalisation via a dedicated wrapper。",
          "methods": "精确对角化。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 a Python package for ground-state preparation based on the probabilistic imaginary-time evolution algorithm, with particular focus on its state-vector-based implementation。",
          ...
          "priorityReason": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "comments": "28 pages, 11 figures. Package available at this https URL",
          "journalRef": "",
          "subjects": "Quantum Physics (quant-ph) ; Strongly Correlated Electrons (cond-mat.str-el)",
          "sourceCategories": [
            "cond-mat.str-el"
          ],
          "url": "https://arxiv.org/abs/2605.07559"
        },
        {
          "id": "2605.07958",
          "title": "Multilayer model for coatings with arbitrary layers for superconducting radio-frequency applications",
          ...
          "important": false,
          "score": -6,
          "oneLine": "本文研究 We extend the multilayer model of \\etal{Kubo} for superconductor-insulator-superconductor (SIS) structures in two ways: first, by generalizing it to arbitrary sequences of layers of...。",
          "problem": "这篇论文关注：We extend the multilayer model of \\etal{Kubo} for superconductor-insulator-superconductor (SIS) structures in two ways: first, by generalizing it to arbitrary sequences of layers of arbitrary type, i.e. superconducting,？",
          "result": "结果表明，We find that the optimum configuration corresponds to the $n=1$ case。",
          "methods": "方法上，We extend the multilayer model of \\etal{Kubo} for superconductor-insulator-superconductor (SIS) structures in two ways: first, by generalizing it to arbitrary sequences of layers of...。",
          "why": "有助于跟踪超导材料、配对机制或临界性质的新进展。",
          "summary": "本文研究 We extend the multilayer model of \\etal{Kubo} for superconductor-insulator-superconductor (SIS) structures in two ways: first, by generalizing it to arbitrary sequences of layers of...。",
          "abstract": "We extend the multilayer model of \\etal{Kubo} for superconductor-insulator-superconductor (SIS) structures in two ways: first, by generalizing it to arbitrary sequences of layers of arbitrary type, i.e. superconducting, normal conducting, and insulating; and second, by accounting for all contributions, including ohmic losses and dielectric effects. We examine the maximum applicable field for $(\\text{SI})^n\\text{S}$ structures. We find that the optimum configuration corresponds to the $n=1$ case. However, the thickness of the superconducting coating layers can be reduced to below their penetration depth with minor performance penalty. We discuss the ability to model transitions in SS bilayers by introducing a set of virtual layers that represent the transition region through interpolated parameters. We find degradation of the maximum applicable field with thicker transition layers, and a larger effective penetration depth of the electromagnetic fields. Furthermore, the surface impedance of the multilayer structure is calculated using the Leontovich boundary condition, yielding a formulation suitable for integration into finite element simulations. Additionally, the Poynting theorem is used to determine the loss contributions of individual layers.",
          ...
          "url": "https://arxiv.org/abs/2605.07958"
        },
        {
          "id": "2605.07592",
          ...
          "important": false,
          "score": -6,
          "oneLine": "本文研究 The CRESST experiment aims at the direct detection of sub-GeV dark matter particles via elastic scattering off nuclei in different target crystals at cryogenic temperatures。",
          "problem": "这篇论文关注：The CRESST experiment aims at the direct detection of sub-GeV dark matter particles via elastic scattering off nuclei in different target crystals at cryogenic temperatures？",
          "result": "结果表明，The results demonstrate a significant performance enhancement and establish new benchmarks for the sensors used within CRESST。",
          "methods": "方法上，The CRESST experiment aims at the direct detection of sub-GeV dark matter particles via elastic scattering off nuclei in different target crystals at cryogenic temperatures。",
          "why": "有助于跟踪超导材料、配对机制或临界性质的新进展。",
          "summary": "本文研究 The CRESST experiment aims at the direct detection of sub-GeV dark matter particles via elastic scattering off nuclei in different target crystals at cryogenic temperatures。",
          ...
          "journalRef": "",
          "subjects": "Instrumentation and Detectors (physics.ins-det) ; Superconductivity (cond-mat.supr-con); High Energy Physics - Experiment (hep-ex)",
          "sourceCategories": [
            "cond-mat.supr-con"
          ],
          "url": "https://arxiv.org/abs/2605.07592"
        }
      ]
    },
    {
      ...
      "note": "今日 arXiv recent 中文整理：共 24 篇，str-el 18 篇，supr-con 8 篇。",
      "stats": {
        "total": 24,
        "str": 18,
        "supr": 8
      ...
      "papers": [
        {
          ...
          "important": true,
          "score": 21,
          "oneLine": "本文研究 the electronic phases of an effective Hubbard model on the body-centered-cubic lattice, motivated by alkali-doped fulleride molecular solids。",
          "problem": "这篇论文关注：the electronic phases of an effective Hubbard model on the body-centered-cubic lattice, motivated by alkali-doped fulleride molecular solids？",
          "result": "结果表明，Within this framework, we analyze the superconducting instability and demonstrate a first-order normal-superconducting phase transition, characterized by a discontinuous jump of the order parameter。",
          "methods": "Hubbard 模型分析。",
          "why": "同时出现在 str-el 与 supr-con，适合优先看强关联与超导交叉。",
          "summary": "本文研究 the electronic phases of an effective Hubbard model on the body-centered-cubic lattice, motivated by alkali-doped fulleride molecular solids。",
        ...
        },
        {
          ...
          "important": true,
          "score": 21,
          "oneLine": "本文研究 Josephson scanning tunneling microscopy (JSTM) has emerged as an important technique for probing the superconducting order parameter at the atomic scale。",
          "problem": "这篇论文关注：Josephson scanning tunneling microscopy (JSTM) has emerged as an important technique for probing the superconducting order parameter at the atomic scale？",
          "result": "结果表明，We demonstrate, using kagome superconductors, that the zero-bias conductance, a key characteristic of the Josephson current, deviates strongly from the quadratic dependence on the normal-state conductance upon...。",
          "methods": "STM/隧穿谱、谱学分析、Josephson 谱学。",
          "why": "包含 kagome 或受挫晶格主题，和强关联材料阅读线索高度相关。",
          "summary": "本文研究 Josephson scanning tunneling microscopy (JSTM) has emerged as an important technique for probing the superconducting order parameter at the atomic scale。",
          ...
          "journalRef": "Phys. Rev. B 113, 174502 (2026)",
          "subjects": "Superconductivity (cond-mat.supr-con)",
          "sourceCategories": [
            "cond-mat.supr-con"
          ],
          "url": "https://arxiv.org/abs/2605.06150"
        },
        {
          "id": "2605.06545",
          ...
          "important": true,
          "score": 20,
          "oneLine": "本文研究 The 1T polymorph of NbSe$_2$, long confined to the monolayer limit, has remained inaccessible in bulk。",
          "problem": "这篇论文关注：The 1T polymorph of NbSe$_2$, long confined to the monolayer limit, has remained inaccessible in bulk？",
          "result": "结果表明，Our results establish electrochemical intercalation as an effective route to stabilize otherwise inaccessible bulk polytypes, positioning bulk 1T-NbSe$_2$ as a new platform for investigating correlated...。",
          "methods": "DFT 计算、输运测量、谱学分析。",
          "why": "同时出现在 str-el 与 supr-con，适合优先看强关联与超导交叉。",
          "summary": "本文研究 The 1T polymorph of NbSe$_2$, long confined to the monolayer limit, has remained inaccessible in bulk。",
          ...
          "url": "https://arxiv.org/abs/2605.06545"
        },
        {
          "id": "2605.06551",
          ...
          "important": false,
          "score": 14,
          "oneLine": "本文研究 a low-energy continuum model to describe the moiré physics of heterostructures, which is a generalization of the celebrated Bistritzer-MacDonald (BM) method [R。",
          "problem": "这篇论文关注：a low-energy continuum model to describe the moiré physics of heterostructures, which is a generalization of the celebrated Bistritzer-MacDonald (BM) method [R？",
          "result": "结果表明，the emergence of higher-order magic angles where significant local band flattening occurs as a high-order Van Hove singularity emerges and show how twisting alone can induce non-trivial topology。",
          "methods": "方法上，H。",
          "why": "包含 kagome 或受挫晶格主题，和强关联材料阅读线索高度相关。",
          "summary": "本文研究 a low-energy continuum model to describe the moiré physics of heterostructures, which is a generalization of the celebrated Bistritzer-MacDonald (BM) method [R。",
          ...
          "url": "https://arxiv.org/abs/2605.06551"
        },
        {
          "id": "2605.06069",
          ...
          "important": false,
          "score": 11,
          "oneLine": "本文研究 Competing interactions, non-trivial electronic band topology, quantum fluctuations, and the interplay between emergent degrees of freedom in frustrated quantum materials can give rise to a...。",
          "problem": "这篇论文关注：Competing interactions, non-trivial electronic band topology, quantum fluctuations, and the interplay between emergent degrees of freedom in frustrated quantum materials can give rise to a wide range of exotic phenomena？",
          "result": "结果表明，Using a comprehensive set of experimental probes, including thermodynamic, NMR, ($\\mu$SR), and neutron scattering, we identify characteristic signatures of topological spin-glass behavior and these...。",
          "methods": "中子散射实验、NMR 谱学。",
          "why": "涉及受挫磁性，适合关注低维量子磁性和新奇基态。",
          "summary": "本文研究 Competing interactions, non-trivial electronic band topology, quantum fluctuations, and the interplay between emergent degrees of freedom in frustrated quantum materials can give rise to a...。",
          ...
          "url": "https://arxiv.org/abs/2605.06069"
        },
        {
          "id": "2605.05571",
          ...
          "important": false,
          "score": 10,
          "oneLine": "本文研究 Moiré superlattices formed by transition metal dichalcogenide (TMD) heterobilayers provide a versatile platform for studying strongly correlated electronic, excitonic, and topological...。",
          "problem": "这篇论文关注：Moiré superlattices formed by transition metal dichalcogenide (TMD) heterobilayers provide a versatile platform for studying strongly correlated electronic, excitonic, and topological phenomena in solids？",
          "result": "结果表明，Our results provide a holistic understanding of the emergent optical excitations and the correlated charge-transfer states in electron-doped MoSe$_2$/WS$_2$ moiré superlattices。",
          "methods": "Monte Carlo 模拟、Hubbard 模型分析、谱学分析。",
          "why": "Hubbard 模型相关，适合从模型层面理解关联与配对。",
          "summary": "本文研究 Moiré superlattices formed by transition metal dichalcogenide (TMD) heterobilayers provide a versatile platform for studying strongly correlated electronic, excitonic, and topological...。",
        ...
        },
        {
          ...
          "important": false,
          "score": 9,
          "oneLine": "本文研究 The realization of intrinsic, tunable high-frequency quantum states without external radiation is a major goal in condensed matter physics and quantum device engineering。",
          "problem": "这篇论文关注：The realization of intrinsic, tunable high-frequency quantum states without external radiation is a major goal in condensed matter physics and quantum device engineering？",
          "result": "结果表明，a uniformly sliding charge-density wave (CDW) acts as an intrinsic dc-to-ac converter, transforming spatial periodicity into temporal periodicity to realize a unique periodically driven quantum。",
          "methods": "输运测量、谱学分析。",
          "why": "涉及 CDW，适合和 kagome、TMD 或超导竞争序联系阅读。",
          "summary": "本文研究 The realization of intrinsic, tunable high-frequency quantum states without external radiation is a major goal in condensed matter physics and quantum device engineering。",
          ...
          "priorityReason": "涉及 CDW，适合和 kagome、TMD 或超导竞争序联系阅读。",
          "comments": "",
          "journalRef": "",
          "subjects": "Mesoscale and Nanoscale Physics (cond-mat.mes-hall) ; Strongly Correlated Electrons (cond-mat.str-el)",
          "sourceCategories": [
          ...
          "url": "https://arxiv.org/abs/2605.05894"
        },
        {
          "id": "2605.06649",
          ...
          "important": false,
          "score": 5,
          "oneLine": "本文研究 The emergence of colossal magnetoresistance in a new generation of Eu$^{2+}$-based antiferromagnets is intriguing given stark contrasts to the archetypal perovskite manganites and doped...。",
          "problem": "这篇论文关注：The emergence of colossal magnetoresistance in a new generation of Eu$^{2+}$-based antiferromagnets is intriguing given stark contrasts to the archetypal perovskite manganites and doped Eu-chalcogenides？",
          "result": "结果表明，In this study the thermal conductivity and magnetostriction of Eu$_5$Sn$_2$As$_6$ -- one such representative -- have been measured to better understand the role of the crystal lattice。",
          "methods": "方法上，Both properties are strongly field-dependent and mirror the magnetization, saturating once the Eu$^{2+}$ moments are polarized。",
          "why": "涉及受挫磁性，适合关注低维量子磁性和新奇基态。",
          "summary": "本文研究 The emergence of colossal magnetoresistance in a new generation of Eu$^{2+}$-based antiferromagnets is intriguing given stark contrasts to the archetypal perovskite manganites and doped...。",
          ...
          "url": "https://arxiv.org/abs/2605.06649"
        },
        {
          "id": "2605.05981",
          ...
          "important": false,
          "score": 5,
          "oneLine": "本文研究 High-current superconducting cables are emerging as key enablers for next-generation power transmission systems; however, their deployment is often limited by transport AC losses。",
          "problem": "这篇论文关注：High-current superconducting cables are emerging as key enablers for next-generation power transmission systems; however, their deployment is often limited by transport AC losses？",
          "result": "结果表明，By comparing configurations in which the total current is either injected through a common connection between the CORC and TSTC conductors (non-insulated feeding) or supplied independently to each conductor...。",
          "methods": "输运测量。",
          "why": "涉及扭转结构，适合关注 moire 或层状材料中的新奇相。",
          "summary": "本文研究 High-current superconducting cables are emerging as key enablers for next-generation power transmission systems; however, their deployment is often limited by transport AC losses。",
          ...
          "url": "https://arxiv.org/abs/2605.05981"
        },
        {
          "id": "2605.05433",
          ...
          "important": false,
          "score": 5,
          "oneLine": "本文研究 the spectrum of collective modes in a superconductor in which pairing is mediated by long-range nematic fluctuations。",
          "problem": "这篇论文关注：the spectrum of collective modes in a superconductor in which pairing is mediated by long-range nematic fluctuations？",
          "result": "结果表明，the spectral function, $\\operatorname{Im}\\chi(\\mathbf{q},\\Omega)$, and its pole structure in the transverse (phase) and longitudinal (amplitude) channels, and compare the results with those of a conventional。",
          "methods": "方法上，the spectrum of collective modes in a superconductor in which pairing is mediated by long-range nematic fluctuations。",
          "why": "涉及 nematic 物理，适合关注对称性破缺与配对机制。",
          "summary": "本文研究 the spectrum of collective modes in a superconductor in which pairing is mediated by long-range nematic fluctuations。",
          ...
          "priorityReason": "涉及 nematic 物理，适合关注对称性破缺与配对机制。",
          "comments": "",
          "journalRef": "",
          "subjects": "Superconductivity (cond-mat.supr-con)",
          "sourceCategories": [
        ...
        },
        {
          ...
          "important": false,
          "score": 5,
          "oneLine": "本文研究 Quantum many-body scars in Rydberg atom arrays have thus far only been observed on bipartite lattices, leaving open the question of whether and how they survive frustration, and what the...。",
          "problem": "这篇论文关注：Quantum many-body scars in Rydberg atom arrays have thus far only been observed on bipartite lattices, leaving open the question of whether and how they survive frustration, and what the appropriate initial states are？",
          "result": "结果表明，We introduce a graph-theoretic framework to find suitable candidates for scarring on arbitrary lattices。",
          "methods": "方法上，Our framework predicts two distinct mechanisms: type-I scars generalize the bipartite case by using locally entangled states to overcome mild frustration, while type-II scars exploit strong...。",
          "why": "涉及受挫磁性，适合关注低维量子磁性和新奇基态。",
          "summary": "本文研究 Quantum many-body scars in Rydberg atom arrays have thus far only been observed on bipartite lattices, leaving open the question of whether and how they survive frustration, and what the...。",
        ...
        },
        {
          ...
          "important": false,
          "score": 3,
          "oneLine": "本文研究 Two-dimensional honeycomb lattice ferromagnet chromium tri-iodide (CrI$_3$) has attracted tremendous interest because it retains ferromagnetism down to the monolayer limit and hosts...。",
          "problem": "这篇论文关注：Two-dimensional honeycomb lattice ferromagnet chromium tri-iodide (CrI$_3$) has attracted tremendous interest because it retains ferromagnetism down to the monolayer limit and hosts intriguing topological magnons？",
          "result": "结果表明，In addition, we find that the magnon energy follows a $T^2$-renormalization behavior at elevated temperatures, consistent with magnon-magnon interactions。",
          "methods": "重整化群分析、中子散射实验。",
          "why": "包含中子散射线索，适合关注磁结构和集体激发。",
          "summary": "本文研究 Two-dimensional honeycomb lattice ferromagnet chromium tri-iodide (CrI$_3$) has attracted tremendous interest because it retains ferromagnetism down to the monolayer limit and hosts...。",
          ...
          "url": "https://arxiv.org/abs/2605.06291"
        },
        {
          "id": "2605.05587",
          ...
          "important": false,
          "score": 3,
          "oneLine": "本文研究 Collective quantum states are often associated with extended systems, where spatially extensive degrees of freedom enable emergent many-body behavior; whether such strongly correlated...。",
          "problem": "这篇论文关注：Collective quantum states are often associated with extended systems, where spatially extensive degrees of freedom enable emergent many-body behavior; whether such strongly correlated states survive at atomic dimensions？",
          "result": "结果表明，collective quantum matter can persist and exhibit fundamentally distinct coupling behavior at atomic length scales, establishing a novel platform for engineering strongly correlated quantum。",
          "methods": "谱学分析。",
          "why": "包含谱学信息，可帮助快速判断实验可观测量。",
          "summary": "本文研究 Collective quantum states are often associated with extended systems, where spatially extensive degrees of freedom enable emergent many-body behavior; whether such strongly correlated...。",
          ...
          "url": "https://arxiv.org/abs/2605.05587"
        },
        {
          "id": "2605.06661",
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 We introduce the pro-tensor network, a categorification of the tensor network, as a fully rigorous yet graphically transparent framework for studying the collection of many many-body...。",
          "problem": "这篇论文关注：We introduce the pro-tensor network, a categorification of the tensor network, as a fully rigorous yet graphically transparent framework for studying the collection of many many-body theories, which we dub？",
          "result": "结果表明，As applications, we recover the Levin-Wen model as a \"uniform\" pro-tensor network and generalize a result of Kitaev and Kong by characterizing particles as modules over promonads。",
          "methods": "方法上，We provide a comprehensive toolbox for the graphical calculations using pro-tensor networks。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 We introduce the pro-tensor network, a categorification of the tensor network, as a fully rigorous yet graphically transparent framework for studying the collection of many many-body...。",
          ...
          "journalRef": "",
          "subjects": "Strongly Correlated Electrons (cond-mat.str-el) ; High Energy Physics - Theory (hep-th); Mathematical Physics (math-ph); Category Theory (math.CT); Quantum Algebra (math.QA)",
          "sourceCategories": [
            "cond-mat.str-el"
          ],
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 The response of ultra-thin superconducting materials under parallel magnetic fields is often leveraged to obtain insight into the nature of the condensate, including features attributable...。",
          "problem": "这篇论文关注：The response of ultra-thin superconducting materials under parallel magnetic fields is often leveraged to obtain insight into the nature of the condensate, including features attributable to unconventional forms of？",
          "result": "结果表明，Despite there being multiple competing mechanisms responsible for suppressing superconductivity, it is common for these analyses to overlook certain depairing channels。",
          "methods": "方法上，Here we report an analysis of thickness dependent superconductivity in thin films of \\ce{LaBi2} using the multi-mechanism Kharitonov-Feigel'man framework。",
          "why": "有助于跟踪超导材料、配对机制或临界性质的新进展。",
          "summary": "本文研究 The response of ultra-thin superconducting materials under parallel magnetic fields is often leveraged to obtain insight into the nature of the condensate, including features attributable...。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 The strongly correlated phases of the homogeneous electron gas constitute the vocabulary of many-body condensed matter physics and find a natural realization in semiconductors。",
          "problem": "这篇论文关注：The strongly correlated phases of the homogeneous electron gas constitute the vocabulary of many-body condensed matter physics and find a natural realization in semiconductors？",
          "result": "结果表明，The strongly correlated phases of the homogeneous electron gas constitute the vocabulary of many-body condensed matter physics and find a natural realization in semiconductors。",
          "methods": "Monte Carlo 模拟。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 The strongly correlated phases of the homogeneous electron gas constitute the vocabulary of many-body condensed matter physics and find a natural realization in semiconductors。",
          ...
          "url": "https://arxiv.org/abs/2605.06302"
        },
        {
          "id": "2605.06109",
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 Intrinsic defects govern carrier trapping and recombination in two-dimensional semiconductors, yet the microscopic origin of defect-dependent capture dynamics remains unclear。",
          "problem": "这篇论文关注：Intrinsic defects govern carrier trapping and recombination in two-dimensional semiconductors, yet the microscopic origin of defect-dependent capture dynamics remains unclear？",
          "result": "结果表明，We find that the single Sulphur vacancy forms a shallow defect with a small capture coefficient of $\\sim 10^{-16}\\ \\mathrm{cm}^3/\\mathrm{s}$, whereas the Sulphur divacancy exhibits a capture coefficient larger...。",
          "methods": "方法上，Here, we compute carrier capture coefficients of vacancy defects, treating monolayer MoS$_2$ as a prototype, from first principles。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 Intrinsic defects govern carrier trapping and recombination in two-dimensional semiconductors, yet the microscopic origin of defect-dependent capture dynamics remains unclear。",
          ...
          "url": "https://arxiv.org/abs/2605.06109"
        },
        {
          "id": "2605.05847",
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 Hybrid two-dimensional electron gas-superconductor (2DEG-S) structures in a quantized magnetic field offer a promising platform for realizing new topological phases。",
          "problem": "这篇论文关注：Hybrid two-dimensional electron gas-superconductor (2DEG-S) structures in a quantized magnetic field offer a promising platform for realizing new topological phases？",
          "result": "结果表明，While recent experiments reveal chiral Andreev edge states, their charge conductance is not integer quantized and is disorder sensitive, raising the question of whether topological protection survives。",
          "methods": "输运测量。",
          "why": "有助于跟踪超导材料、配对机制或临界性质的新进展。",
          "summary": "本文研究 Hybrid two-dimensional electron gas-superconductor (2DEG-S) structures in a quantized magnetic field offer a promising platform for realizing new topological phases。",
          ...
          "url": "https://arxiv.org/abs/2605.05847"
        },
        {
          "id": "2605.05800",
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 Critical current density is the key parameter for the practical application of superconductivity。",
          "problem": "这篇论文关注：Critical current density is the key parameter for the practical application of superconductivity？",
          "result": "结果表明，In this study, 3 MeV proton irradiation experiments were conducted on HgBa$_2$Ca$_2$Cu$_3$O$_8$$_+$$_\\delta$ single crystals to introduce pinning centers。",
          "methods": "方法上，In this study, 3 MeV proton irradiation experiments were conducted on HgBa$_2$Ca$_2$Cu$_3$O$_8$$_+$$_\\delta$ single crystals to introduce pinning centers。",
          "why": "有助于跟踪超导材料、配对机制或临界性质的新进展。",
          "summary": "本文研究 Critical current density is the key parameter for the practical application of superconductivity。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 The spin-1/2 Heisenberg antiferromagnetic chain is the canonical example of an integrable quantum many-body model。",
          "problem": "这篇论文关注：The spin-1/2 Heisenberg antiferromagnetic chain is the canonical example of an integrable quantum many-body model？",
          "result": "结果表明，both the ground state wavefunction and the Bethe-roots rapidly develop algebraic complexity with respect to system size, but at different rates。",
          "methods": "方法上，the algebraic structure of the exact, symbolic ground states for chains up to ten sites using the coordinate Bethe ansatz。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 The spin-1/2 Heisenberg antiferromagnetic chain is the canonical example of an integrable quantum many-body model。",
        ...
        {
          "id": "2605.05516",
          "title": "Field-Induced Local Excitations Causing Zero-Magnetization Plateaus in Antiferromagnets of Antiferromagnetic Spin Dimers Under Magnetic Field",
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 Certain antiferromagnets composed of antiferromagnetic spin dimers exhibit a zero-magnetization plateau despite that the single-ion anisotropy of their magnetic ions is negligible。",
          "problem": "这篇论文关注：Certain antiferromagnets composed of antiferromagnetic spin dimers exhibit a zero-magnetization plateau despite that the single-ion anisotropy of their magnetic ions is negligible？",
          "result": "结果表明，The cause for this observation was investigated by analyzing how a magnetic field affects the energy spectrum of an antiferromagnetic chain composed of antiferromagnetic spin dimers made up of two spin-half...。",
          "methods": "方法上，The cause for this observation was investigated by analyzing how a magnetic field affects the energy spectrum of an antiferromagnetic chain composed of antiferromagnetic spin dimers made up...。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 Certain antiferromagnets composed of antiferromagnetic spin dimers exhibit a zero-magnetization plateau despite that the single-ion anisotropy of their magnetic ions is negligible。",
          ...
          "priorityReason": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "comments": "35 pages and 10 figires, 2006, accepted for publication Chemistry of Materials",
          "journalRef": "",
          "subjects": "Strongly Correlated Electrons (cond-mat.str-el)",
          "sourceCategories": [
            "cond-mat.str-el"
          ],
          "url": "https://arxiv.org/abs/2605.05516"
        },
        {
          "id": "2605.05307",
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 the crystalline phase of the $O(2N)$ Gross--Neveu model with a chemical potential for $a \\leq N-2$ of the fermions。",
          "problem": "这篇论文关注：the crystalline phase of the $O(2N)$ Gross--Neveu model with a chemical potential for $a \\leq N-2$ of the fermions？",
          "result": "结果表明，In this paper, we provide the necessary details of each of the three methods, thereby complementing the results announced in a previous, shorter publication。",
          "methods": "平均场理论。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 the crystalline phase of the $O(2N)$ Gross--Neveu model with a chemical potential for $a \\leq N-2$ of the fermions。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 Conventional approaches to simulating quantum many-body dynamics produce a single trajectory: if the Hamiltonian or the initial state is changed, the computation must be re-performed。",
          "problem": "这篇论文关注：Conventional approaches to simulating quantum many-body dynamics produce a single trajectory: if the Hamiltonian or the initial state is changed, the computation must be re-performed？",
          "result": "结果表明，We benchmark on a two-dimensional driven Ising model and demonstrate the UNP's accuracy and transferability across product and entangled initial states, as well as for both in- and out-of-distribution driving...。",
          "methods": "精确对角化。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 Conventional approaches to simulating quantum many-body dynamics produce a single trajectory: if the Hamiltonian or the initial state is changed, the computation must be re-performed。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 a microscopic theory of charged excitations in an SU(2) Chern ferromagnet and obtain closed-form wavefunctions for a hierarchy of charge-$e$ spin polaron states binding an arbitrary number...。",
          "problem": "这篇论文关注：a microscopic theory of charged excitations in an SU(2) Chern ferromagnet and obtain closed-form wavefunctions for a hierarchy of charge-$e$ spin polaron states binding an arbitrary number of spin flips？",
          "result": "结果表明，In an ideal Chern-$1$ band with a normal-ordered contact interaction, we show that these polarons are exact eigenstates of the Hamiltonian with the same energy as single-hole excitations。",
          "methods": "精确对角化。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 a microscopic theory of charged excitations in an SU(2) Chern ferromagnet and obtain closed-form wavefunctions for a hierarchy of charge-$e$ spin polaron states binding an arbitrary number...。",
          ...
          "url": "https://arxiv.org/abs/2605.05292"
        }
      ]
    }
  ]
