window.ARXIV_DAILY_DATA = {
  "updatedAt": "2026-05-11T20:48:40.408Z",
  ...
  "days": [
    {
      ...
      "papers": [
        ...
        },
        {
          ...
          "important": false,
          "score": 8,
          "oneLine": "本文研究 SrCu2(BO3)2 (SCBO) is paradigmatic realization的Shastry-Sutherland model, hosting geometrically frustrated 自旋二聚体 和 variety的quantum magnetic phases 和 phenomena。",
          "problem": "这篇论文想回答：电子激发 在 Shastry-Sutherland 化合物 SrCu_2(BO_3)_2的核心物理是什么？",
          "result": "结果表明，Taken together, these 结果 define characteristic energy scales的d-d 和 CT excitations, offering quantitative benchmarks 用于 computational frameworks 和 providing essential input 用于 refining。",
          "methods": "DFT 计算、谱学分析、X 射线表征。",
          "why": "涉及受挫磁性，适合关注低维量子磁性和新奇基态。",
          "summary": "本文研究 SrCu2(BO3)2 (SCBO) is paradigmatic realization的Shastry-Sutherland model, hosting geometrically frustrated 自旋二聚体 和 variety的quantum magnetic phases 和 phenomena。",
        ...
        },
        {
          ...
          "important": false,
          "score": 6,
          "oneLine": "本文研究 Majorana zero modes are central to pursuit的fault-tolerant 拓扑 quantum computation。",
          "problem": "这篇论文想回答：Majorana 束缚态 在手性铁磁-超导异质结构 revisited的机制和物理后果是什么？",
          "result": "结果表明，Our analytical 结果 explicitly demonstrate critical role的spin-orbit coupling 用于 stabilization的Majorana modes 和 提供 approximate analytical expressions 用于 low-lying states localized at。",
          "methods": "方法上，Such skyrmion-vortex pairs have recently been realized experimentally 和 are theorized to harbor localized Majorana states, offering potential pathway 用于 braiding operations。",
          "why": "涉及 Majorana 物理，适合关注拓扑超导与器件解释。",
          "summary": "本文研究 Majorana zero modes are central to pursuit的fault-tolerant 拓扑 quantum computation。",
        ...
        },
        {
          ...
          "important": false,
          "score": 6,
          "oneLine": "本文研究 Rutile RuO_2 has attracted significant interest due to its putative un常规 electronic 和 magnetic properties 和 its proximity to 超导。",
          "problem": "这篇论文想回答：Disentangling 体态和表面电子结构 利用 定向解理面 在RuO_2的核心物理是什么？",
          "result": "结果表明，how preparation的targeted (110) 和 (100) 表面s 通过 focused ion beam (FIB)-engineered cleaving allows acquisition的high-quality measurements的electronic structure 利用。",
          "methods": "ARPES 谱学、谱学分析。",
          "why": "包含谱学信息，可帮助快速判断实验可观测量。",
          "summary": "本文研究 Rutile RuO_2 has attracted significant interest due to its putative un常规 electronic 和 magnetic properties 和 its proximity to 超导。",
        ...
        },
        {
          ...
          "important": false,
          "score": 5,
          "oneLine": "本文研究 Quantum-disordered magnetic 基态 are challenging to identify 在三维 (3D) oxides, where strong exchange pathways typically favour long-range magnetic order 或 spin freezing。",
          "problem": "这篇论文想回答：Emergent Dynamic Magnetic 基态 在 Mixed 3d/5d 重费米子体系 CaCu3Ir4O12背后的磁性机制是什么？",
          "result": "结果表明，Quantum-disordered magnetic 基态 are challenging to identify 在三维 (3D) oxides, where strong exchange pathways typically favour long-range magnetic order 或 spin freezing。",
          "methods": "方法上，Here, we combine 体相 probes, 包括 DC 和 AC magnetic susceptibility, 和 热容测量 (down to 50~mK), along 具有 local microscopic probe muon spin relaxation (μSR) (down to。",
          "why": "涉及 heavy fermion，适合关注强关联低能准粒子与量子临界。",
          "summary": "本文研究 Quantum-disordered magnetic 基态 are challenging to identify 在三维 (3D) oxides, where strong exchange pathways typically favour long-range magnetic order 或 spin freezing。",
        ...
        },
        {
          ...
          "important": false,
          "score": 5,
          "oneLine": "本文研究 triangular lattice antiferromagnet (TLAF) 具有 nearest-neighbor exchange interaction is model platform 在 field的frustrated magnetism。",
          "problem": "这篇论文想回答：Frustration的harmonic 和 solitonic 螺旋磁性 在 体心四方晶格的GdAlSi背后的磁性机制是什么？",
          "result": "结果表明，体心四方晶格 (BCTL) can realize similar frustration的harmonic 和 anharmonic helimagnetic states, 和 that tetragonal magnetic Weyl semimetal GdAlSi realizes this scenario。",
          "methods": "平均场理论、X 射线表征。",
          "why": "涉及受挫磁性，适合关注低维量子磁性和新奇基态。",
          "summary": "本文研究 triangular lattice antiferromagnet (TLAF) 具有 nearest-neighbor exchange interaction is model platform 在 field的frustrated magnetism。",
        ...
        },
        {
          ...
          "important": false,
          "score": 5,
          "oneLine": "本文研究 在general, quantum fluctuations are suppressed 在ferromagnetic materials because they admit simple unfrustrated 基态, greatly limiting scope的phenomena that can be observed 在these materials。",
          "problem": "这篇论文想回答：Fluctuation-driven 手性铁磁性背后的磁性机制是什么？",
          "result": "结果表明，在这项工作, 表明 how magnetization-non-conserving couplings fundamentally alter this paradigm by demonstrating existence的chiral ferromagnet that is 稳定d by quantum fluctuations。",
          "methods": "输运测量。",
          "why": "涉及受挫磁性，适合关注低维量子磁性和新奇基态。",
          "summary": "本文研究 在general, quantum fluctuations are suppressed 在ferromagnetic materials because they admit simple unfrustrated 基态, greatly limiting scope的phenomena that can be observed 在these materials。",
        ...
        },
        {
          ...
          "important": false,
          "score": 3,
          "oneLine": "本文研究 comprehensive NMR study的chiral square-cupola antiferromagnet Pb(TiO)Cu_4(PO_4)_4 和 compare its microscopic hyperfine 和 local-field parameters 具有 Ba/Sr analogues 在。",
          "problem": "这篇论文想回答：微观磁性的(TiO)Cu4(PO4)4 ( = Ba, Pb, Sr): 31P 和 63,65Cu NMR Study背后的磁性机制是什么？",
          "result": "结果表明，Comparing PbTCPO 具有 BaTCPO 和 SrTCPO, 发现 that transferred hyperfine coupling H_\\rm hf varies across series, reflecting changes 在local Cu-O-P covalency, whereas ordered-state ^31P internal。",
          "methods": "NMR 谱学。",
          "why": "包含 NMR 线索，适合关注磁性和低能涨落。",
          "summary": "本文研究 comprehensive NMR study的chiral square-cupola antiferromagnet Pb(TiO)Cu_4(PO_4)_4 和 compare its microscopic hyperfine 和 local-field parameters 具有 Ba/Sr analogues 在。",
        ...
        },
        {
          ...
          "important": false,
          "score": 3,
          "oneLine": "本文研究 parafermion 准粒子 具有 non-Abelian statistics have been proposed as promising platform 用于 quantum computation, potentially enabling broader set的拓扑ly protected gates than Majorana fermions。",
          "problem": "这篇论文想回答：Shuttling的Z_4 parafermion 准粒子 在 电子梯子模型的核心物理是什么？",
          "result": "结果表明，experimental 和 theoretical exploration的these exotic quasiparticles remains challenging, as their stability is linked to strong electron-electron interactions。",
          "methods": "重整化群分析、输运测量。",
          "why": "涉及 Majorana 物理，适合关注拓扑超导与器件解释。",
          "summary": "本文研究 parafermion 准粒子 具有 non-Abelian statistics have been proposed as promising platform 用于 quantum computation, potentially enabling broader set的拓扑ly protected gates than Majorana fermions。",
        ...
        },
        {
          ...
          "important": false,
          "score": 3,
          "oneLine": "本文研究 test的共形不变性 在critical phenomena 基于 study的two-point correlation function 在 presence的boundary。",
          "problem": "这篇论文想回答：Direct Experimental Test的共形不变性 通过 Grazing Scattering: Proposal 用于 X 射线和中子实验的核心物理是什么？",
          "result": "结果表明，This two-point function can be studied 利用 X-ray 或 中子散射 在 conditions的total reflection (so-called grazing scattering)。",
          "methods": "中子散射实验、X 射线表征。",
          "why": "包含中子散射线索，适合关注磁结构和集体激发。",
          "summary": "本文研究 test的共形不变性 在critical phenomena 基于 study的two-point correlation function 在 presence的boundary。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 celebrated Kronig-Penney 模型 traditionally has been formulated 具有 square well potentials representing atomic centres。",
          "problem": "这篇论文想回答：Analytical Solution to Kronig-Penney 模型 具有 谐振子势阱: Insights to 紧束缚的核心物理是什么？",
          "result": "结果表明，Here, we use slightly more realistic potential, truncated harmonic oscillator, 在lieu的square well potentials, 和 solve model analytically。",
          "methods": "紧束缚模型。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 celebrated Kronig-Penney 模型 traditionally has been formulated 具有 square well potentials representing atomic centres。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 classification的有能隙相 或 massive renormalization group (RG) flows dual to massless RG flows under changing sign的coupling constants。",
          "problem": "这篇论文想回答：Characterizing 体相 properties的有能隙相 by smeared 边界共形场论: Role的duality 在unusual ordering的核心物理是什么？",
          "result": "结果表明，用于 example, 证明 that massive RG flow dual to massless RG flow 来自 tricritical Ising model to Ising model, one的simplest massless RG flows, has this unusual structure。",
          "methods": "重整化群分析。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 classification的有能隙相 或 massive renormalization group (RG) flows dual to massless RG flows under changing sign的coupling constants。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 entanglement structure的quantum many-body states defines natural 和 optimal distributed representation 用于 their simulation。",
          "problem": "这篇论文想回答：Entanglement-informed distributed 波函数方法 to scalable 量子多体系统的核心物理是什么？",
          "result": "结果表明，entanglement structure的quantum many-body states defines natural 和 optimal distributed representation 用于 their simulation。",
          "methods": "方法上，entanglement structure的quantum many-body states defines natural 和 optimal distributed representation 用于 their simulation。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 entanglement structure的quantum many-body states defines natural 和 optimal distributed representation 用于 their simulation。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 Magnetoelectric (ME) effects 在antiferromagnets 提供 fertile platform 用于 exploring symmetry-driven cross-correlated responses。",
          "problem": "这篇论文想回答：Revisiting 磁电响应 在collinear 反铁磁 zigzag 链: 降维有效模型方法 beyond 常规 low-energy models背后的磁性机制是什么？",
          "result": "结果表明，利用 analytical 和 numerical calculations 基于 Kubo formula, 证明 that ME response is governed by orbital degrees的freedom activated through s--p hybridization, while spin contribution。",
          "methods": "重整化群分析、紧束缚模型。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 Magnetoelectric (ME) effects 在antiferromagnets 提供 fertile platform 用于 exploring symmetry-driven cross-correlated responses。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 We have investigated weak antilocalization (WAL) 在 pressurized Dirac semimetal α-(BEDT-TTF)_2I_3 across correlation-driven quantum phase transition to charge-ordered insulating state 和。",
          "problem": "这篇论文想回答：Anomalous 相干相位标度 在 量子临界 Dirac 半金属的核心物理是什么？",
          "result": "结果表明，在 high-pressure regime, system exhibits 常规 二维 dephasing behavior (L_\\phi \\propto T^-p 具有 p \\approx 1/2), characteristic的electron-electron scattering 在diffusive。",
          "methods": "方法上，As pressure approaches critical pressure (P_c \\sim 1.2 GPa), temperature exponent is suppressed to p \\sim 0.3, while L_\\phi remains large (700-800 nm at 0.5 K)。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 We have investigated weak antilocalization (WAL) 在 pressurized Dirac semimetal α-(BEDT-TTF)_2I_3 across correlation-driven quantum phase transition to charge-ordered insulating state 和。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 claims by Park 和 Haldane [Phys。",
          "problem": "这篇论文想回答：Does 分数量子霍尔边缘 Have Protected 内禀偶极矩?的核心物理是什么？",
          "result": "结果表明，Contrary to prevailing expectations, 发现 that edge dipole takes expected intrinsic value only 在certain very special cases。",
          "methods": "重整化群分析。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 claims by Park 和 Haldane [Phys。",
        ...
        },
        {
          ...
          "important": false,
          "score": -5,
          "oneLine": "本文研究 Python package 用于 ground-state preparation 基于 概率虚时演化 algorithm, 具有 particular focus 在 its state-vector-based implementation。",
          "problem": "这篇论文想回答：svPITE: Python package 用于 state-vector-based 概率虚时演化 algorithm的核心物理是什么？",
          "result": "结果表明，standard shot-based simulation is also supported, 和 结果 can be benchmarked against exact diagonalisation 通过 dedicated wrapper。",
          "methods": "精确对角化。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 Python package 用于 ground-state preparation 基于 概率虚时演化 algorithm, 具有 particular focus 在 its state-vector-based implementation。",
        ...
        },
        {
          ...
          "important": false,
          "score": -6,
          "oneLine": "本文研究 CRESST experiment aims at direct detection的sub-GeV dark matter particles 通过 elastic scattering off nuclei 在different target crystals at cryogenic temperatures。",
          "problem": "这篇论文想回答：Optimisation的TES design 用于 CRESST experiment的核心物理是什么？",
          "result": "结果表明，结果 demonstrate significant performance enhancement 和 establish new benchmarks 用于 sensors used within CRESST。",
          "methods": "方法上，CRESST experiment aims at direct detection的sub-GeV dark matter particles 通过 elastic scattering off nuclei 在different target crystals at cryogenic temperatures。",
          "why": "有助于跟踪超导材料、配对机制或临界性质的新进展。",
          "summary": "本文研究 CRESST experiment aims at direct detection的sub-GeV dark matter particles 通过 elastic scattering off nuclei 在different target crystals at cryogenic temperatures。",
      ...
      "papers": [
        {
          ...
          "important": true,
          "score": 21,
          "oneLine": "本文研究 electronic phases的effective Hubbard 模型 在 body-centered-cubic lattice, motivated by alkali-doped fulleride molecular solids。",
          "problem": "BCC 晶格有效 Hubbard 模型中超导、Mott 与磁性关联相如何竞争？",
          "result": "结果表明，Within this framework, we analyze 超导 instability 和 demonstrate first-order normal-超导 phase transition, characterized by discontinuous jump的order parameter。",
          "methods": "Hubbard 模型分析。",
          "why": "同时出现在 str-el 与 supr-con，适合优先看强关联与超导交叉。",
          "summary": "本文研究 electronic phases的effective Hubbard 模型 在 body-centered-cubic lattice, motivated by alkali-doped fulleride molecular solids。",
        ...
        },
        {
          ...
          "score": 21,
          "oneLine": "提出用于谱学数据的概率去噪方法，强调信号恢复的可靠性和不确定性。",
          "problem": "kagome 超导体在深点接触极限下的 Josephson 谱如何解释？",
          "result": "结果表明，该概率模型能在带泊松噪声的三维 ARPES 数据中可靠恢复铜氧化物超导体的谱特征。",
        ...
        },
        {
          ...
          "important": true,
          "score": 20,
          "oneLine": "本文研究 1T polymorph的NbSe_2, long confined to monolayer limit, has remained inaccessible 在体相。",
          "problem": "金属插层能否在体相 1T-NbSe2 中诱导关联绝缘态？",
          "result": "结果表明，Our 结果 establish electrochemical intercalation as effective route to 稳定 otherwise inaccessible 体相 polytypes, positioning 体相 1T-NbSe_2 as new platform 用于 investigating correlated electronic states。",
          "methods": "DFT 计算、输运测量、谱学分析。",
          "why": "同时出现在 str-el 与 supr-con，适合优先看强关联与超导交叉。",
          "summary": "本文研究 1T polymorph的NbSe_2, long confined to monolayer limit, has remained inaccessible 在体相。",
        ...
        },
        {
          ...
          "important": false,
          "score": 14,
          "oneLine": "本文研究 low-energy continuum model to describe moiré physics的heterostructures, which is generalization的celebrated Bistritzer-MacDonald (BM) method [R。",
          "problem": "扭转 kagome 双层中魔角、拓扑平带和子晶格干涉如何出现？",
          "result": "结果表明，emergence的higher-order 魔角 where significant local band flattening occurs as high-order Van Hove singularity emerges 和 show how twisting alone can induce non-trivial topology。",
          "methods": "方法上，H。",
          "why": "包含 kagome 或受挫晶格主题，和强关联材料阅读线索高度相关。",
          "summary": "本文研究 low-energy continuum model to describe moiré physics的heterostructures, which is generalization的celebrated Bistritzer-MacDonald (BM) method [R。",
        ...
        },
        {
          ...
          "important": false,
          "score": 11,
          "oneLine": "本文研究 Competing interactions, non-trivial electronic band topology, quantum fluctuations, 和 interplay between emergent degrees的freedom 在frustrated quantum materials can give rise to wide range的exotic phenomena。",
          "problem": "受挫量子材料中的慢自旋动力学能否由拓扑自旋冻结解释？",
          "result": "结果表明，利用 comprehensive set的experimental probes, 包括 thermodynamic, NMR, (μSR), 和 中子散射, 识别出 characteristic signatures的拓扑 spin-glass behavior 和 these complementary。",
          "methods": "中子散射实验、NMR 谱学。",
          "why": "涉及受挫磁性，适合关注低维量子磁性和新奇基态。",
          "summary": "本文研究 Competing interactions, non-trivial electronic band topology, quantum fluctuations, 和 interplay between emergent degrees的freedom 在frustrated quantum materials can give rise to wide range的exotic phenomena。",
        ...
        },
        {
          ...
          "important": false,
          "score": 10,
          "oneLine": "本文研究 moiré 超晶格 formed by transition metal dichalcogenide (TMD) heterobilayers 提供 versatile platform 用于 studying strongly correlated electronic, excitonic, 和 拓扑 phenomena 在solids。",
          "problem": "这篇论文想回答：Tunable 层间电荷转移态 在MoSe_2/WS_2 moiré 超晶格的核心物理是什么？",
          "result": "结果表明，Our 结果 提供 holistic understanding的emergent optical excitations 和 correlated charge-transfer states 在electron-doped MoSe_2/WS_2 moiré 超晶格。",
          "methods": "Monte Carlo 模拟、Hubbard 模型分析、谱学分析。",
          "why": "Hubbard 模型相关，适合从模型层面理解关联与配对。",
          "summary": "本文研究 moiré 超晶格 formed by transition metal dichalcogenide (TMD) heterobilayers 提供 versatile platform 用于 studying strongly correlated electronic, excitonic, 和 拓扑 phenomena 在solids。",
        ...
        },
        {
          ...
          "important": false,
          "score": 9,
          "oneLine": "说明滑动电荷密度波可把空间周期转化为时间周期，从而产生内禀 Floquet 侧带。",
          "problem": "滑动电荷密度波是否能自发产生 Floquet 态和量子振荡？",
          "result": "结果表明，uniformly 滑动 电荷密度波 (电荷密度波) acts as intrinsic dc-to-ac converter, transforming spatial periodicity into temporal periodicity to realize unique periodically driven quantum。",
          "methods": "输运测量、谱学分析。",
          "why": "涉及 CDW，适合和 kagome、TMD 或超导竞争序联系阅读。",
          "summary": "说明滑动电荷密度波可把空间周期转化为时间周期，从而产生内禀 Floquet 侧带。",
        ...
        },
        {
          ...
          "important": false,
          "score": 5,
          "oneLine": "本文研究 emergence的colossal 磁阻 在 new generation的Eu^2+-based antiferromagnets is intriguing given stark contrasts to archetypal perovskite manganites 和 doped Eu-chalcogenides。",
          "problem": "这篇论文想回答：Colossal 磁阻 和 声子驱动的交换动力学 在Eu_5Sn_2As_6背后的磁性机制是什么？",
          "result": "结果表明，在this study thermal conductivity 和 magnetostriction的Eu_5Sn_2As_6 -- one such representative -- have been measured to better understand role的crystal lattice。",
          "methods": "方法上，Both properties are strongly field-dependent 和 mirror magnetization, saturating once Eu^2+ moments are polarized。",
          "why": "涉及受挫磁性，适合关注低维量子磁性和新奇基态。",
          "summary": "本文研究 emergence的colossal 磁阻 在 new generation的Eu^2+-based antiferromagnets is intriguing given stark contrasts to archetypal perovskite manganites 和 doped Eu-chalcogenides。",
        ...
        },
        {
          ...
          "important": false,
          "score": 5,
          "oneLine": "本文研究 High-current 超导 cables are emerging as key 使得rs 用于 next-generation power transmission systems; however, their deployment is often limited by 输运交流损耗。",
          "problem": "这篇论文想回答：Massive Mitigation的输运交流损耗 在超导 Hybrid CORC-TSTC Cables的机制和物理后果是什么？",
          "result": "结果表明，By comparing configurations 在which total current is either injected through common connection between CORC 和 TSTC conductors (non-insulated feeding) 或 supplied independently to each conductor (insulated。",
          "methods": "输运测量。",
          "why": "涉及扭转结构，适合关注 moire 或层状材料中的新奇相。",
          "summary": "本文研究 High-current 超导 cables are emerging as key 使得rs 用于 next-generation power transmission systems; however, their deployment is often limited by 输运交流损耗。",
        ...
        },
        {
          ...
          "important": false,
          "score": 5,
          "oneLine": "本文研究 spectrum的集体模 在 超导体 在which pairing is mediated by long-range nematic 涨落。",
          "problem": "这篇论文想回答：超导 mediated by nematic 涨落 -- dispersion的集体模的机制和物理后果是什么？",
          "result": "结果表明，spectral function, \\operatornameIm\\chi(\\mathbfq,Ω), 和 its pole structure 在 transverse (phase) 和 longitudinal (amplitude) channels, 和 compare 结果 具有 those的常规。",
          "methods": "方法上，spectrum的集体模 在 超导体 在which pairing is mediated by long-range nematic 涨落。",
          "why": "涉及 nematic 物理，适合关注对称性破缺与配对机制。",
          "summary": "本文研究 spectrum的集体模 在 超导体 在which pairing is mediated by long-range nematic 涨落。",
        ...
        },
        {
          ...
          "important": false,
          "score": 5,
          "oneLine": "本文研究 Quantum many-body scars 在Rydberg atom arrays have thus far only been observed 在 bipartite lattices, leaving open question的whether 和 how they survive frustration, 和 what appropriate initial states are。",
          "problem": "这篇论文想回答：Systematic construction的quantum many-body scars 在frustrated Rydberg 阵列的核心物理是什么？",
          "result": "结果表明，We introduce graph-theoretic framework to find suitable 候选s 用于 scarring 在 arbitrary lattices。",
          "methods": "方法上，Our framework predicts two distinct mechanisms: type-I scars generalize bipartite case by 利用 locally entangled states to overcome mild frustration, while type-II scars exploit strong...。",
          "why": "涉及受挫磁性，适合关注低维量子磁性和新奇基态。",
          "summary": "本文研究 Quantum many-body scars 在Rydberg atom arrays have thus far only been observed 在 bipartite lattices, leaving open question的whether 和 how they survive frustration, 和 what appropriate initial states are。",
        ...
        },
        {
          ...
          "important": false,
          "score": 3,
          "oneLine": "本文研究 二维 honeycomb lattice ferromagnet chromium tri-iodide (CrI_3) has attracted tremendous interest because it retains ferromagnetism down to monolayer limit 和 hosts intriguing 拓扑 magnons。",
          "problem": "这篇论文想回答：Winding feature 和 thermal evolution的Dirac 磁振子 在CrI_3的核心物理是什么？",
          "result": "结果表明，在addition, 发现 that magnon energy follows T^2-renormalization behavior at elevated temperatures, 符合 magnon-magnon interactions。",
          "methods": "重整化群分析、中子散射实验。",
          "why": "包含中子散射线索，适合关注磁结构和集体激发。",
          "summary": "本文研究 二维 honeycomb lattice ferromagnet chromium tri-iodide (CrI_3) has attracted tremendous interest because it retains ferromagnetism down to monolayer limit 和 hosts intriguing 拓扑 magnons。",
        ...
        },
        {
          ...
          "important": false,
          "score": 3,
          "oneLine": "本文研究 Collective quantum states are often associated 具有 extended systems, where spatially extensive degrees的freedom 使得 emergent many-body behavior; whether such strongly correlated states survive at atomic dimensions。",
          "problem": "这篇论文想回答：Collective quantum state at 原子极限的核心物理是什么？",
          "result": "结果表明，collective quantum matter can persist 和 exhibit fundamentally distinct coupling behavior at atomic length scales, establishing novel platform 用于 engineering strongly correlated quantum。",
          "methods": "谱学分析。",
          "why": "包含谱学信息，可帮助快速判断实验可观测量。",
          "summary": "本文研究 Collective quantum states are often associated 具有 extended systems, where spatially extensive degrees的freedom 使得 emergent many-body behavior; whether such strongly correlated states survive at atomic dimensions。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 We introduce pro-tensor network, categorification的tensor network, as fully rigorous yet graphically transparent framework 用于 studying collection的many many-body theories, which we dub。",
          "problem": "这篇论文想回答：Pro-Tensor Network的核心物理是什么？",
          "result": "结果表明，As applications, we recover Levin-Wen model as \"uniform\" pro-tensor network 和 generalize result的Kitaev 和 Kong by characterizing particles as modules over promonads。",
          "methods": "方法上，We 提供 comprehensive toolbox 用于 graphical calculations 利用 pro-tensor networks。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 We introduce pro-tensor network, categorification的tensor network, as fully rigorous yet graphically transparent framework 用于 studying collection的many many-body theories, which we dub。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 response的ultra-thin 超导 materials under parallel magnetic fields is often leveraged to obtain insight into nature的condensate, 包括 features attributable to un常规 forms的。",
          "problem": "这篇论文想回答：破对效应 和 Dimensionality 在自旋轨道耦合超导体的机制和物理后果是什么？",
          "result": "结果表明，Despite there being multiple competing mechanisms responsible 用于 suppressing 超导, it is common 用于 these analyses to overlook certain depairing channels。",
          "methods": "方法上，Here 报道 analysis的thickness dependent 超导 在thin films的\\ceLaBi2 利用 multi-mechanism Kharitonov-Feigel'man framework。",
          "why": "有助于跟踪超导材料、配对机制或临界性质的新进展。",
          "summary": "本文研究 response的ultra-thin 超导 materials under parallel magnetic fields is often leveraged to obtain insight into nature的condensate, 包括 features attributable to un常规 forms的。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 strongly 关联相的homogeneous electron gas constitute vocabulary的many-body condensed matter physics 和 find natural realization 在semiconductors。",
          "problem": "电子系统能否不依赖外部 moiré 势而自发形成准晶态？",
          "result": "结果表明，strongly 关联相的homogeneous electron gas constitute vocabulary的many-body condensed matter physics 和 find natural realization 在semiconductors。",
          "methods": "Monte Carlo 模拟。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 strongly 关联相的homogeneous electron gas constitute vocabulary的many-body condensed matter physics 和 find natural realization 在semiconductors。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 Intrinsic defects govern carrier trapping 和 recombination 在二维 semiconductors, yet 微观起源的defect-dependent capture dynamics remains unclear。",
          "problem": "这篇论文想回答：Dominant Role的硫双空位 在电荷俘获动力学 在MoS_2的核心物理是什么？",
          "result": "结果表明，发现 that single Sulphur vacancy forms shallow defect 具有 small capture coefficient的\\sim 10^-16\\ cm^3/s, whereas 硫双空位 exhibits capture coefficient larger by seven。",
          "methods": "方法上，Here, we compute carrier capture coefficients的vacancy defects, treating monolayer MoS_2 as prototype, 来自 first principles。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 Intrinsic defects govern carrier trapping 和 recombination 在二维 semiconductors, yet 微观起源的defect-dependent capture dynamics remains unclear。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 Hybrid 二维电子气-超导体 (2DEG-S) structures 在 quantized magnetic field offer promising platform 用于 realizing new 拓扑 phases。",
          "problem": "这篇论文想回答：Emergent 自旋量子霍尔边缘态 at boundary的二维电子气 proximitized by s 波超导体的机制和物理后果是什么？",
          "result": "结果表明，While recent experiments 揭示 chiral Andreev 边缘态, their charge conductance is not integer quantized 和 is disorder sensitive, raising question的whether 拓扑 protection survives。",
          "methods": "输运测量。",
          "why": "有助于跟踪超导材料、配对机制或临界性质的新进展。",
          "summary": "本文研究 Hybrid 二维电子气-超导体 (2DEG-S) structures 在 quantized magnetic field offer promising platform 用于 realizing new 拓扑 phases。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 临界电流密度 Jc is key parameter 用于 practical application的超导。",
          "problem": "这篇论文想回答：Enhancement的临界电流密度 Jc by 质子辐照 在HgBa_2Ca_2Cu_3O_8_+_δ Single Crystals的核心物理是什么？",
          "result": "结果表明，在this study, 3 MeV 质子辐照 experiments were conducted 在 HgBa_2Ca_2Cu_3O_8_+_δ single crystals to introduce pinning centers。",
          "methods": "方法上，在this study, 3 MeV 质子辐照 experiments were conducted 在 HgBa_2Ca_2Cu_3O_8_+_δ single crystals to introduce pinning centers。",
          "why": "有助于跟踪超导材料、配对机制或临界性质的新进展。",
          "summary": "本文研究 临界电流密度 Jc is key parameter 用于 practical application的超导。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 spin-1/2 Heisenberg antiferromagnetic chain is canonical example的integrable quantum many-body model。",
          "problem": "这篇论文想回答：Galois Solvability的Finite-Size Bethe 解 在 Heisenberg 链的核心物理是什么？",
          "result": "结果表明，both 基态 wavefunction 和 Bethe-roots rapidly develop algebraic complexity 具有 respect to system size, but at different rates。",
          "methods": "方法上，algebraic structure的exact, symbolic 基态 用于 chains up to ten sites 利用 coordinate Bethe ansatz。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 spin-1/2 Heisenberg antiferromagnetic chain is canonical example的integrable quantum many-body model。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 Certain antiferromagnets composed的antiferromagnetic 自旋二聚体 exhibit 零磁化平台 despite that single-ion anisotropy的their magnetic ions is negligible。",
          "problem": "这篇论文想回答：Field-Induced Local Excitations Causing 零磁化平台 在Antiferromagnets的Antiferromagnetic 自旋二聚体 Under Magnetic Field背后的磁性机制是什么？",
          "result": "结果表明，cause 用于 this observation was investigated by analyzing how magnetic field affects energy spectrum的antiferromagnetic chain composed的antiferromagnetic 自旋二聚体 made up的two spin-half ions 和 by。",
          "methods": "方法上，cause 用于 this observation was investigated by analyzing how magnetic field affects energy spectrum的antiferromagnetic chain composed的antiferromagnetic 自旋二聚体 made up的two spin-half ions 和 by。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 Certain antiferromagnets composed的antiferromagnetic 自旋二聚体 exhibit 零磁化平台 despite that single-ion anisotropy的their magnetic ions is negligible。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 crystalline phase的O(2N) Gross--Neveu model 具有 chemical potential 用于 \\leq N-2的fermions。",
          "problem": "这篇论文想回答：Perturbative, Nonperturbative 和 Exact Aspects的Crystalline Phases 在 Gross-Neveu Model的核心物理是什么？",
          "result": "结果表明，在这篇论文, we 提供 necessary details的each的three methods, thereby complementing 结果 announced 在 previous, shorter publication。",
          "methods": "平均场理论。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 crystalline phase的O(2N) Gross--Neveu model 具有 chemical potential 用于 \\leq N-2的fermions。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 常规 approaches to simulating quantum many-body dynamics produce single trajectory: if Hamiltonian 或 initial state is changed, computation must be re-performed。",
          "problem": "这篇论文想回答：Universal Neural Propagator: Learning Time Evolution 在Many-Body Quantum Systems的核心物理是什么？",
          "result": "结果表明，We benchmark 在 二维 driven Ising model 和 demonstrate UNP's accuracy 和 transferability across product 和 entangled initial states, 以及 用于 both 在- 和 out-的-distribution driving protocols。",
          "methods": "精确对角化。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 常规 approaches to simulating quantum many-body dynamics produce single trajectory: if Hamiltonian 或 initial state is changed, computation must be re-performed。",
        ...
        },
        {
          ...
          "important": false,
          "score": 0,
          "oneLine": "本文研究 microscopic theory的charged excitations 在 SU(2) Chern 铁磁体 和 obtain closed-form wavefunctions 用于 层级结构的charge-e 自旋极化子 states binding arbitrary number的spin flips。",
          "problem": "这篇论文想回答：Microsopic Theory的自旋极化子 在Chern 铁磁体背后的磁性机制是什么？",
          "result": "结果表明，在 ideal Chern-1 band 具有 normal-ordered contact interaction, 表明 that these polarons are exact eigenstates的Hamiltonian 具有 same energy as single-hole excitations。",
          "methods": "精确对角化。",
          "why": "有助于跟踪强关联体系中的新材料、新模型或新实验线索。",
          "summary": "本文研究 microscopic theory的charged excitations 在 SU(2) Chern 铁磁体 和 obtain closed-form wavefunctions 用于 层级结构的charge-e 自旋极化子 states binding arbitrary number的spin flips。",
